...
export function DevPill() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 m-4 flex flex-col gap-1 rounded-lg border border-border bg-background p-3 pr-12">
      <Text>Dev Mode</Text>
      ...
      <Text variant={'detail'} className="opacity-50">
        {envs.RAFFLE_API_URL}
      </Text>
    </div>
  );
